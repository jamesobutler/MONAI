...
RIGHT_CASES = [
    (rng.random(3, 4).astype(np.float32), 5, (3, 4, 1, 1, 1)),
    (torch.rand(3, 4).type(torch.float32), 5, (3, 4, 1, 1, 1)),
    (rng.random(3, 4).astype(np.float64), 5, (3, 4, 1, 1, 1)),
    (torch.rand(3, 4).type(torch.float64), 5, (3, 4, 1, 1, 1)),
    (rng.random(3, 4).astype(np.int32), 5, (3, 4, 1, 1, 1)),
    (torch.rand(3, 4).type(torch.int32), 5, (3, 4, 1, 1, 1)),
]

LEFT_CASES = [
    (rng.random(3, 4).astype(np.float32), 5, (1, 1, 1, 3, 4)),
    (torch.rand(3, 4).type(torch.float32), 5, (1, 1, 1, 3, 4)),
    (rng.random(3, 4).astype(np.float64), 5, (1, 1, 1, 3, 4)),
    (torch.rand(3, 4).type(torch.float64), 5, (1, 1, 1, 3, 4)),
    (rng.random(3, 4).astype(np.int32), 5, (1, 1, 1, 3, 4)),
    (torch.rand(3, 4).type(torch.int32), 5, (1, 1, 1, 3, 4)),
]
ALL_CASES = [
    (rng.random(3, 4), 2, (3, 4)),
    (rng.random(3, 4), 0, (3, 4)),
    (rng.random(3, 4), -1, (3, 4)),
    (np.array(3), 4, (1, 1, 1, 1)),
    (np.array(3), 0, ()),
    (rng.random(3, 4).astype(np.int32), 2, (3, 4)),
    (rng.random(3, 4).astype(np.int32), 0, (3, 4)),
    (rng.random(3, 4).astype(np.int32), -1, (3, 4)),
